...
exports.seed = async function(knex) {
    ...
    await knex('users').insert([
      {
        ...
        email: process.env.DEFAULT_ADMIN_EMAIL || 'admin@upsamail.edu.gh',
  ...
  await knex('system_settings').insert([
    ...
    {
      key: 'support_email',
      value: process.env.ORG_EMAIL || 'support@upsamail.edu.gh',
    ...
    {
      key: 'email_domain',
      value: process.env.EMAIL_DOMAIN || '@upsamail.edu.gh',
  ...
  console.log('📧 Default admin email:', process.env.DEFAULT_ADMIN_EMAIL || 'admin@upsamail.edu.gh');
