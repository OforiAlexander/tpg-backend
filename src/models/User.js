// src/models/User.js - TPG User Model with Objection.js (Fixed Schema)
...
class User extends Model {
  ...
  // Define the JSON schema for validation - SIMPLIFIED to avoid AJV issues
  ...
  async $beforeInsert(context) {
    ...
    // Hash password if it's being set (REQUIRED for new users)
    if (this.password) {
      ...
      // If neither password nor password_hash is provided, throw error
