...
module.exports = {
  getAttachments: controller.getAttachments.bind(controller),
  uploadAttachment: controller.uploadAttachment.bind(controller),
  downloadAttachment: controller.downloadAttachment.bind(controller),
  deleteAttachment: controller.deleteAttachment.bind(controller),
  getAttachmentMetadata: controller.getAttachmentMetadata.bind(controller)
};